...
public class Playlist extends AppCompatActivity {
    ...
    void requestPermission()
    {
        ...
        {
            Toast.makeText(Playlist.this, "READ PERMISSION IS REQUIRED, PLEASE ALLOW FROM SETTINGS", Toast.LENGTH_SHORT).show();
        }
        ActivityCompat.requestPermissions(Playlist.this,new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},
                123);
